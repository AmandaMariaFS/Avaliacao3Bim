...
public class ShoppingController : Controller
{
    private static List<LojaViewModel> lojas = 
        new List<LojaViewModel>{
            new LojaViewModel(32, "piso 3", "Tênis Brasil", "Aqui você encontra os tênis", "Loja", "tenis@email.com"),
            new LojaViewModel(33, "piso 3", "Lembranças Já", "Vem comprar sua lembrança", "Kiosque", "lemb@email.com"),
            new LojaViewModel(34, "piso 1", "Sorvetinho Gelado", "Sorvetinho Gelado", "Kiosque", "sorvet@email.com")
        };
